...
}> = ({ rooms, materialResults, onMaterialResultChange, materials, onSaveMaterial, onOpenSupplierRequest }) => {
...
const CalculatorView: React.FC<{
    ...
    rooms, setRooms, handleInputFocus, 
    onSaveEstimate, onLoadEstimate, onOpenLibrary, materials, onSaveMaterial, 
    materialResults, onMaterialResultChange, onOpenSupplierRequest 
}) => {
